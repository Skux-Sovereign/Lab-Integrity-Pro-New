...
export default function Products() {
  ...
  return (
    <>
      ...
      <section className="products-main" id="services">
        <div className="container">

          {/* Three Primary Service Cards */}
          <div className="primary-services-section">
          ...
          <section className="sop-accelerators">
            ...
            <div className="accelerator-grid">
              ...
              <div className="accelerator-card">
                ...
                <Link href="/contact?product=Essential GLP" className="accelerator-cta">
                  Get Started
                </Link>
              </div>
              ...
              <div className="accelerator-card">
                ...
                <Link href="/contact?product=Professional GLP" className="accelerator-cta">
                  Get Started
                </Link>
              </div>
              ...
              <div className="accelerator-card">
                ...
                <Link href="/contact?product=Enterprise GLP" className="accelerator-cta">
                  Get Started
                </Link>
              </div>
